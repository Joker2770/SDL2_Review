...
bool LTexture::loadFromRenderedText(SDL_Renderer* mRenderer, std::string sFontPath, std::string textureText, SDL_Color textColor)
{
	//Get rid of preexisting texture
	free();

	//Open the font
	mFont = TTF_OpenFont(sFontPath.c_str(), 28);
	if (mFont == NULL)
	{
